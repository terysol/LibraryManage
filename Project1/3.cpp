...
selectuser:
	...
	buyerselect:
		...
		case 3:
			...
			goto buyerselect;
			break;
		case 4: PrintLoading("사용자 프로그램 접근해제중");
			goto selectuser;
			break;
...
void connectDB() {
	...
	// 데이터베이스와 연결
	ConnPtr = mysql_real_connect(&Conn, "localhost", "root", "mirim", "products", 3306, NULL, 0);
